 ...
 */
class TopShouldStartLoadWithRequestEvent(surfaceId: Int, viewId: Int, private val mData: WritableMap) : Event<TopShouldStartLoadWithRequestEvent>(surfaceId, viewId) {
  companion object {
