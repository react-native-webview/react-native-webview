...
var WebView = /** @class */ (function (_super) {
    ...
    WebView.prototype.render = function () {
        var _b;
        var _c = this.props, decelerationRateProp = _c.decelerationRate, _d = _c.nativeConfig, nativeConfig = _d === void 0 ? {} : _d, onMessage = _c.onMessage, onShouldStartLoadWithRequestProp = _c.onShouldStartLoadWithRequest, originWhitelist = _c.originWhitelist, renderError = _c.renderError, renderLoading = _c.renderLoading, _e = _c.injectedJavaScriptForMainFrameOnly, injectedJavaScriptForMainFrameOnly = _e === void 0 ? true : _e, _f = _c.injectedJavaScriptBeforeContentLoadedForMainFrameOnly, injectedJavaScriptBeforeContentLoadedForMainFrameOnly = _f === void 0 ? true : _f, style = _c.style, containerStyle = _c.containerStyle, otherProps = __rest(_c, ["decelerationRate", "nativeConfig", "onMessage", "onShouldStartLoadWithRequest", "originWhitelist", "renderError", "renderLoading", "injectedJavaScriptForMainFrameOnly", "injectedJavaScriptBeforeContentLoadedForMainFrameOnly", "style", "containerStyle"]);
        var otherView = null;
        ...
        var NativeWebView = nativeConfig.component
            || RNCWebView;
        var webView = (<NativeWebView key="webViewKey" {...otherProps} decelerationRate={decelerationRate} messagingEnabled={typeof onMessage === 'function' || ((_b = this.props.enableMessaging) !== null && _b !== void 0 ? _b : false)} onLoadingError={this.onLoadingError} onLoadingFinish={this.onLoadingFinish} onLoadingProgress={this.onLoadingProgress} onFileDownload={this.props.onFileDownload} onLoadingStart={this.onLoadingStart} onHttpError={this.onHttpError} onMessage={this.onMessage} onScroll={this.props.onScroll} onShouldStartLoadWithRequest={onShouldStartLoadWithRequest} onContentProcessDidTerminate={this.onContentProcessDidTerminate} injectedJavaScript={this.props.injectedJavaScript} injectedJavaScriptBeforeContentLoaded={this.props.injectedJavaScriptBeforeContentLoaded} injectedJavaScriptForMainFrameOnly={injectedJavaScriptForMainFrameOnly} injectedJavaScriptBeforeContentLoadedForMainFrameOnly={injectedJavaScriptBeforeContentLoadedForMainFrameOnly} ref={this.webViewRef} 
