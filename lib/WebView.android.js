...
var WebView = /** @class */ (function (_super) {
    ...
    function WebView() {
        ...
        _this.onPause = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), _this.getCommands().onPause, undefined);
        };
        _this.onResume = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewHandle(), _this.getCommands().onResume, undefined);
        };
        return _this;
    }
