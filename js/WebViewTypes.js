...
export type WebViewSharedProps = $ReadOnly<{|
  ...
  /**
   * Function that is invoked when the webview calls `window.ReactNativeWebview_postMessage`.
   * Setting this property will inject this global into your webview.
   *
   * `window.ReactNativeWebview_postMessage` accepts one argument, `data`, which will be
